"""phase1 initial models

Revision ID: ff2adbebbb7e
Revises: 
Create Date: 2026-09-20 07:06:30.543163
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('clerk', 'verifier', 'district_officer', 'admin', name='userrole'), nullable=False),
    ...
    sa.Column('status', sa.Enum('uploaded', 'processing', 'needs_review', 'verified', 'rejected', name='documentstatus'), nullable=False),
    sa.Column('district', sa.String(length=100), nullable=True),
    ...
    sa.Column('plot_area_unit', sa.String(length=20), nullable=True),
    sa.Column('land_classification', sa.String(length=100), nullable=True),
    sa.Column('mutation_records', sa.JSON(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('land_record_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['land_record_id'], ['land_records.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
